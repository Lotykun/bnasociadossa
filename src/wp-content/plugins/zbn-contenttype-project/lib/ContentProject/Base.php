...
class Base {
    ...
    public function adminEnqueueScripts() {
        ...
        wp_register_script(Helpers::NAME, Helpers::jsUrl( Helpers::NAME.'-project.js' ), array('jquery'), '20170604', false);
    ...
    public function hide_options() {
        ...
        if(!array_intersect($allowed_roles, $user->roles)) {
            unset($submenu["edit.php?post_type=project"][15]);
            unset($submenu["edit.php?post_type=project"][16]);
            unset($submenu["edit.php?post_type=project"][17]);
        }
    }
}